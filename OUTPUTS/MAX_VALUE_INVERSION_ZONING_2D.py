...
########################################################################################################
## 2DMG C3 V&V
#case_name = 'OBJECTIVES45_TEST03_2DTriMG_HTTR_AVS'
#group = 2
...
#######################################################################################################
# 2DMG C3 V&V
case_name = 'OBJECTIVES6_TEST_SUITE_2DTriMG_HTTR'
group = 2
k = 3  # change to 1, 2, or 3
...
#######################################################################################################
# 2DMG C3 V&V
case_name = 'OBJECTIVES45_TEST10_2DTriMG_HTTR_AVS3S'
group = 2
k = 3  # change to 1, 2, or 3
...
########################################################################################################
# Load data from JSON file
with open(f'{case_name}/{case_name}_level1_UNFOLDING/{case_name}_level1_07_BACK/{case_name}_level1_dS_unfold_BACK_output.json', 'r') as json_file:
    noise_output_C3 = json.load(json_file)
